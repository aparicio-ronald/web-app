...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { course_name: @professor.course_name, name: @professor.name, section_number: @professor.section_number } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { course_name: @professor.course_name, name: @professor.name, section_number: @professor.section_number } }
